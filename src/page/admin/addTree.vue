      ...
      <div v-for="(tree, index) in v" :key="index">
        ...
        <van-swipe-cell :right-width="65" :left-width="65">
          ...
          <van-field
            ...
            disabled
          />
          <van-uploader slot="right" :after-read="onRead" accept="image/gif, image/jpeg">
            <van-icon v-show="upload" name="photograph" size="40px"/>
